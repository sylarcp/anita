...
def get_g12_pos_nbufs(ip_db, offset):
    try:
        ...
        g12_poss = engine.execute('select nbuf, now, time from g12_pos offset ' + offset + ' limit 20000;').fetchall()
...
def get_g12_sat_nbufs(ip_db, offset):
    try:
        ...
        g12_sats = engine.execute('select nbuf, now, time from g12_sat offset ' + offset + ' limit 20000;').fetchall()
